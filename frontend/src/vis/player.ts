...
export class VisPlayer extends Phaser.GameObjects.Container {
	...
	constructor(mapScene: VisMap, playerObject: Player) {
		...
		this.playerLight = new LightEffect(mapScene, 5);
		this.playerLight.x += this.playerSprite.width * 0.5;
		this.playerLight.y += this.playerSprite.height * 0.5;

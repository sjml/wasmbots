(module
  ...
  (func (;3;) (type 2) (param i32 i32)
    ...
    local.get 2
    i32.const 0
    i32.load offset=1049118 align=2
  ...
  (func (;13;) (type 2) (param i32 i32)
    ...
    local.get 2
    i32.const 0
    i64.load offset=1048894 align=1
    local.tee 6
    i64.store offset=48
    local.get 2
    local.get 6
    ...
    global.set 0)
  (func (;14;) (type 1))
  (func (;15;) (type 9) (param i32 i32 i32) (result i32)
  ...
  (func (;18;) (type 4) (param i32 i32 i32)
    ...
    i32.add
    global.set 0)
  (func (;19;) (type 0) (param i32 i32 i32 i32) (result i32)
    (local i32 i32 i32 i32)
    i32.const 0
    local.set 4
    block  ;; label = @1
    ...
    local.get 4)
  (func (;20;) (type 10) (param i32 i32 i32 i32 i32 i32) (result i32)
    (local i32)
    block  ;; label = @1
      local.get 2
      i32.const 65535

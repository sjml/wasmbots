(module
  ...
  (func (;1;) (type 4) (param i32 i32)
    ...
    i32.add
    i32.const 0
    i32.load16_u offset=1049112
    i32.store16
    local.get 2
    i32.const 0
    i32.load offset=1049108 align=2
  ...
  (func (;2;) (type 1)
    ...
    call 3
    drop)
  (func (;3;) (type 5) (param i64) (result i64)
    (local i64)
    i64.const 0
    local.set 1
  ...
  (func (;9;) (type 2) (param i32 i32 i32 i32)
    (local i64 i32 i32)
    block  ;; label = @1
      block  ;; label = @2
        local.get 3
  ...
  (elem (;0;) (i32.const 1) func 2 9 12 17 18 19)
  (data (;0;) (i32.const 1048576) "ERROR: Can't parse GameParams v{d}; only prepared for v{d}\00CLIENT ERROR: u16 read will overrun reserve memory\00CLIENT ERROR: Writing u8 outside of reserve memory\00CLIENT ERROR: Writing u16 outside of reserve memory\00CLIENT ERROR: Could not allocate reserve memory\00bot_zig\00CLIENT ERROR: Attempting to reserve memory twice\0000010203040506070809101112131415161718192021222324252627282930313233343536373839404142434445464748495051525354555657585960616263646566676869707172737475767778798081828384858687888990919293949596979899\00Good to go!\00\00\00\00\01\00\00\00\00\00\04\00\00\00\05\00\00\00\06\00\00\00\00\00\00\00\1c\02\10\00P\02\10\00\10\00\00\00")
  (data (;1;) (i32.const 1049144) "\03\00\00\00\00\00\00\00\aa\aa\aa\aa\00\00\00\00"))

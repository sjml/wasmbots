(module
  ...
  (func (;11;) (type 6) (param i32 i32) (result i32)
    ...
    i64.store align=1
    i32.const 1)
  (func (;12;) (type 9) (param i64) (result i64)
    (local i64)
    i64.const 0
    local.set 1
  ...
  (func (;14;) (type 3) (param i32 i32 i32 i32)
    (local i32)
    local.get 3
    i32.const 1
    i32.and
  ...
  (func (;18;) (type 2) (param i32 i32 i32 i32 i32 i32) (result i32)
    ...
    local.get 2)
  (func (;19;) (type 1) (param i32 i32 i32 i32 i32)
    local.get 1
    i32.const 65535
    i32.add
    i32.const 16
    ...
    i32.add
    call 15)
  (func (;20;) (type 0) (param i32 i32 i32 i32) (result i32)
  ...
  (func (;27;) (type 2) (param i32 i32 i32 i32 i32 i32) (result i32)
    ...
    local.get 5
    call 29)
  (func (;28;) (type 10) (param i32 i32 i32) (result i32)
    (local i32)
    global.get 0
    i32.const 32
    i32.sub
    ...
    global.set 0
    local.get 2)
  (func (;29;) (type 2) (param i32 i32 i32 i32 i32 i32) (result i32)
    (local i32 i32)
    global.get 0
    i32.const 16
    i32.sub
    ...
    global.set 0
    local.get 0)
  (func (;30;) (type 1) (param i32 i32 i32 i32 i32)
    ...
    i32.add
    global.set 0)
  (func (;31;) (type 1) (param i32 i32 i32 i32 i32)
  ...
  (func (;32;) (type 4) (param i32 i32 i32)
    ...
    i32.add
    global.set 0)
  (func (;33;) (type 10) (param i32 i32 i32) (result i32)
    (local i32 i32)
    local.get 0
    i32.load
    local.set 0
  ...
  (func (;34;) (type 4) (param i32 i32 i32)
    ...
    local.get 4
    i32.store)
  (func (;35;) (type 10) (param i32 i32 i32) (result i32)
  ...
  (func (;37;) (type 6) (param i32 i32) (result i32)
    ...
    global.set 0
    local.get 0)
  (func (;38;) (type 0) (param i32 i32 i32 i32) (result i32)
    (local i32 i32)
    global.get 0
    i32.const 16
    i32.sub
    ...
    global.set 0
    local.get 5)
  (func (;39;) (type 0) (param i32 i32 i32 i32) (result i32)
    ...
    i32.const 0)
  (func (;40;) (type 10) (param i32 i32 i32) (result i32)
    block  ;; label = @1
      local.get 0
      i32.load
      local.get 1
    ...
    local.get 2)
  (func (;41;) (type 2) (param i32 i32 i32 i32 i32 i32) (result i32)
    (local i32 i32 i32)
    i32.const 0
    local.set 6
    block  ;; label = @1
  ...
  (func (;43;) (type 12) (param i32 i64 i64 i64 i64)
    (local i64)
    local.get 0
    local.get 4
    local.get 1
  ...
  (export "tick" (func 10))
  (export "runFib" (func 11))
  (elem (;0;) (i32.const 1) func 2 5 17 18 19 20 27 30 39 41 42)

...
* I had a lingering memory of [Crobots](https://en.wikipedia.org/wiki/Crobots) (which, in researching again to write this, I distressingly discovered is pronounced "See Robots" and not "Crow-bots" as I had always imagined), where you could write little AIs in a subset of C and have them fight each other! You can get it running [in the Internet Archiveap's DOSBox](https://archive.org/details/msdos_shareware_fb_CROBOT) pretty easily: just run `CR-DEMO.BAT` and press enter until things are done compiling. [The old manual is also good reading!](https://crobots.deepthought.it/html/manual.html) I was tempted to just do a modern version of this, but I don't like guns. 

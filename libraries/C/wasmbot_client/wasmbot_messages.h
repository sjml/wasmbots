...
WasmBots_err_t WasmBots_ProcessRawBytes(WasmBots_DataAccess* r, void*** msgListOut, size_t* len);
...
WasmBots_err_t WasmBots_ProcessRawBytes(WasmBots_DataAccess* r, void*** msgListDst, size_t* len) {

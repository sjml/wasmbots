...
WasmBotsMessage_PlayerMove* WasmBotsMessage_PlayerMove_Create(void);
...
WasmBotsMessage_PlayerMove* WasmBotsMessage_PlayerMove_Create(void) {
    WasmBotsMessage_PlayerMove* out = (WasmBotsMessage_PlayerMove*)malloc(sizeof(WasmBotsMessage_PlayerMove));
    if (out == NULL) { return NULL; }

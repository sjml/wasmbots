...
fn tick(pc: wasmbot_messages::PresentCircumstances) -> wasmbot_messages::Message {
		...
		for pt in &ns {
			...
			match ntile {
				wasmbot_messages::TileType::ClosedDoor => {
					...
					LAST_MOVE_TYPE.with_borrow_mut(|dir| *dir = wasmbot_messages::MessageType::Open);
				...
				wasmbot_messages::TileType::OpenDoor => {
					...
					LAST_MOVE_TYPE.with_borrow_mut(|dir| *dir = wasmbot_messages::MessageType::Close);
	...
	LAST_MOVE_TYPE.with_borrow_mut(|dir| *dir = wasmbot_messages::MessageType::MoveTo);
